...
Learn the most important basics of Markdown in this excellent interactive ["60 Seconds Markdown Tutorial"](https://commonmark.org/help/). There are many options to discover - for example, [this link](#intro) will bring you back to the top of the page. 

However, using Markdown doesn't mean that you can't also use [Hypertext Markup Language (HTML)](https://www.w3schools.com/html/). You can add HTML tags to any Markdown file. This means you can also include HTML iframes to display a web page within a web page. In particular, if you have the URL to a Vimeo or YouTube video, you can use an embeddable `<iframe>` element for the video in question. Like the one below:

<br />

<!--
Hint: you need to open the document in a web browser to view the video (not inside RStudio)
-->


<iframe src="https://player.vimeo.com/video/178485416?color=428bca&title=0&byline=0&portrait=0" width="500" height="300" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
...
In R Markdown it is easy to integrate the results of R code in text elements.  
